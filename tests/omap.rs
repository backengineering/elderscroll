...
fn omap_test1() {
    ...
    omap_stream2.0.insert(OmapEntry(0x1001, 0x100B));
    omap_stream2.0.insert(OmapEntry(0x1002, 0x100E));
    omap_stream2.0.insert(OmapEntry(0x1003, 0x1088));
    omap_stream2.0.insert(OmapEntry(0x1004, 0x1004));
